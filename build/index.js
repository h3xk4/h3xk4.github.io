...
var _user$project$Greeting$sayGoodbye = function (name) {
	return A2(_elm_lang$core$Basics_ops['++'], 'Goodbye ', name);
};
var _user$project$Greeting$sayHello = function (name) {
	return A2(_elm_lang$core$Basics_ops['++'], 'Hello ', name);
};

var _user$project$Nav$simpleNav = function (item) {
	return A2(
...
var _user$project$Main$initialModel = {
	nav: _elm_lang$core$Native_List.fromArray(
		['one', 'two', 'three', 'four']),
	appColor: 'blue'
};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {nav: a, appColor: b};
	});
var _user$project$Main$ChangeAppColor = {ctor: 'ChangeAppColor'};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$html$Html_Attributes$class(model.appColor)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('print-out')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						_user$project$Greeting$sayGoodbye('Eric'))
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onClick(_user$project$Main$ChangeAppColor)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, _user$project$Nav$simpleNav, model.nav))
			]));
};
